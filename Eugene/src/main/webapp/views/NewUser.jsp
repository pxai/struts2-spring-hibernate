...
<html>
	<head>
		<meta charset="utf-8">
		<title>user management : <spring:message code="user.new" text="New user" var="newUser" /></title>
	</head> 
	<body>
		<header>
		<h1>${newUser}</h1>
		...
		<spring:url value="/user/save" var="urlsave" />
		<form:form method="post" action="${urlsave}" commandName="user">
