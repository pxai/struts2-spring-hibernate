...
--
-- Volcar la base de datos para la tabla `car`
--

INSERT INTO `car` (`id`, `registration`, `model`) VALUES
(1, '4653WCE', 'Skoda Fabia TDI'),
(2, '0666EVL', 'Ferrari Enzo');
...
--
-- Volcar la base de datos para la tabla `insurance`
--

INSERT INTO `insurance` (`idcar`, `company`, `type`, `cost`) VALUES
(1, 'AXA', 'Fully Comprehensive', 456.56),
(2, 'AEG', 'Third party', 256.45),
(4, 'Lagun Aro', 'Full', 666.66);
